...
"use strict";jQuery.extend({highlight:function(e,t,i,n){if(3===e.nodeType){var r=e.data.match(t);if(r){var l=document.createElement(i||"span");l.className=n||"highlight";var s=e.splitText(r.index);s.splitText(r[0].length);var a=s.cloneNode(!0);return l.appendChild(a),s.parentNode.replaceChild(l,s),1}}else if(1===e.nodeType&&e.childNodes&&!/(script|style)/i.test(e.tagName)&&(e.tagName!==i.toUpperCase()||e.className!==n))for(var h=0;h<e.childNodes.length;h++)h+=jQuery.highlight(e.childNodes[h],t,i,n);return 0}}),jQuery.fn.unhighlight=function(e){var t={className:"highlight",element:"span"};return jQuery.extend(t,e),this.find(t.element+"."+t.className).each(function(){var e=this.parentNode;e.replaceChild(this.firstChild,this),e.normalize()}).end()},jQuery.fn.highlight=function(e,t){var i={className:"highlight",element:"span",caseSensitive:!1,wordsOnly:!1};if(jQuery.extend(i,t),e.constructor===String&&(e=[e]),e=jQuery.grep(e,function(e,t){return""!=e}),0==(e=jQuery.map(e,function(e,t){return e.replace(/[-[\]{}()*+?.,\\^$|#\s]/g,"\\$&")})).length)return this;var n=i.caseSensitive?"":"i",r="("+e.join("|")+")";i.wordsOnly&&(r="\\b"+r+"\\b");var l=new RegExp(r,n);return this.each(function(){jQuery.highlight(this,l,i.element,i.className)})},function(){var i=void 0,n=void 0,r={element:"span",className:"search-highlight"},l=new lunr.Index;function e(e){if(s(),n.addClass("visible"),27===e.keyCode&&(this.value=""),this.value){var t=l.search(this.value).filter(function(e){return 1e-4<e.score});t.length?(n.empty(),$.each(t,function(e,t){n.append("<li><a href='#"+t.ref+"'>"+$("#"+t.ref).text()+"</a></li>")}),function(){this.value&&i.highlight(this.value,r)}.call(this)):(n.html("<li></li>"),$(".search-results li").text('No Results Found for "'+this.value+'"'))}else s(),n.removeClass("visible");$(".search-results a").click(function(){s(),n.removeClass("visible")})}function s(){i.unhighlight(r)}l.ref("id"),l.field("title",{boost:10}),l.field("body"),l.pipeline.add(lunr.trimmer,lunr.stopWordFilter),$(function(){$(":header:not(.no-toc)").each(function(){var e=$(this),t=e.nextUntil("h1, h2");l.add({id:e.prop("id"),title:e.text(),body:t.text()})})}),$(function(){i=$(".content-container .post"),n=$(".search-results"),$("#input-search").on("keyup",e),$("#input-search").on("click",e)})}();