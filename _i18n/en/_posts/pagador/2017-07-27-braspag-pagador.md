...
Below is the list of acquirers with whom we have integration for refund requests:

|Acquirer|Maximum Deadline for Requesting Reversal|
|-----------|----|
|Cielo|300 days|
|Rede|Komerci integration: 90 days; eRede integration: 60 days|
|Getnet|90 days|
|Transbank|90 days|
|Banorte|30 days|
|First Data|90 days|
...
|**obs 3:**|The value must be unique, ie the bank does not allow repeating previously used values|
...
> The fields of the `FraudAnalysis.Travel` node become mandatory if your business segment is aerial.>
