---
layout: redirect
redirect: https://docs.cielo.com.br/gateway-en/docs/e-wallets
title: E-Wallets
...
> If the merchant will send the authorization request with decrypted card data, please refer to [Decrypted card](https://braspag.github.io//en/manual/ewallets#decrypted-card).
