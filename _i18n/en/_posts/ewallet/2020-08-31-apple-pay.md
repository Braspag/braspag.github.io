...
2. Follow the procedure set on this document, in order to complete your integration with Apple.
...
The merchant identifier must be created through the [Apple Developer Website](https://developer.apple.com/account/resources) as follows:
...
3. Insert values in the **"Description"** and **"Identifier"** fields, in accordance with the specifications, and click **"Continue"**:
...
To send Braspag a request for a certificate in the ".CSR" format, contact our [Support Team](https://suporte.braspag.com.br/hc/pt-br/requests/new), and inform the following:
...
To create a payment processing certificate (".CER"), to be used in your virtual store or app, you must enter the [Apple Developer Website](https://developer.apple.com/account/resources) and follow the procedure below:
...
5. Choose the "No" option in **"Edit or Configure Merchant ID"**:
...
Most of the process of enabling the "Pay with Apple Pay" button in your app or site will be performed during your wallet integration. For that reason, recomendamos que siga as orientações disponíveis no site de [Documentação da Apple](https://developer.apple.com/documentation) para a implementação, que é totalmente self-service.
