...
O Apple Pay é uma carteira virtual. Ele permite que os compradores realizem pagamentos em lojas virtuais e apps utilizando seus cartões de crédito e débito armazenados em suas contas e dispositivos Apple de forma prática e segura.
...
O próximo passo é solicitar à Braspag a geração do certificado no formato ".CSR".<br>Para tanto, entre em contato com o nosso [Time de Atendimento](https://suporte.braspag.com.br/hc/pt-br/requests/new) e informe:
