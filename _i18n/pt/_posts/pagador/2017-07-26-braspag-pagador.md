...
```json
{
    ...
    "Payment": {
        ...
        "ExtraDataCollection": [{
            "Name": "SteloGuaranteed",
            "Value": "true"
        }, {
            "Name": "DeviceFingerPrint",
            "Value": "e72f6e86-0a35-41e4-ba2b-827a49730c90"
        }, {
            "Name": "ShippingBehavior",
            "Value": "DELIVERY"
        }, {
            "Name": "Cart_1_Name",
            "Value": "Caneta Bic"
        }, {
            "Name": "Cart_1_Quantity",
            "Value": 10
        }, {
            "Name": "Cart_1_Price",
            "Value": 150
...
|`Customer.IdentityType`|Texto|255|Não|Tipo de documento de identificação do comprador (CPF ou CNPJ)|
|`Customer.Email`|Texto|255|Não|Email do comprador|
|`Customer.Birthdate`|Date|10|Sim|Data de nascimento do Comprador no formato AAAA-MM-DD|
...
|`Customer.Address.District`|Texto |50 |Não|Bairro do Comprador. |
|`Customer.DeliveryAddress.Street`|Texto|255|Sim|Endereço do comprador|
|`Customer.DeliveryAddress.Number`|Texto|15|Sim|Número do endereço de entrega do pedido|
|`Customer.DeliveryAddress.Complement`|Texto|50|Não|Complemento do endereço de entrega do pedido|
|`Customer.DeliveryAddress.ZipCode`|Texto|9|Sim|CEP do endereço de entrega do pedido|
|`Customer.DeliveryAddress.City`|Texto|50|Sim|Cidade do endereço de entrega do pedido|
|`Customer.DeliveryAddress.State`|Texto|2|Sim|Estado do endereço de entrega do pedido|
|`Customer.DeliveryAddress.Country`|Texto|35|Sim|Pais do endereço de entrega do pedido|
|`Customer.DeliveryAddress.District`|Texto |50 |Não|Bairro do Comprador. |
|`Payment.Provider`|Texto|15|Sim|Nome da provedora de Meio de Pagamento, padrão: Stelo|
|`Payment.Type`|Texto|100|Sim|Tipo do Meio de Pagamento|
|`Payment.Amount`|Número|15|Sim|Valor do Pedido (ser enviado em centavos)|
|`Payment.Installments`|Número|2|Sim|Número de Parcelas|
|`Payment.Capture`|Booleano|---|Não (Default false)|Booleano que indica se a autorização deve ser com captura automática (true) ou não (false). Deverá verificar junto à adquirente a disponibilidade desta funcionalidade|
...
|`CreditCard.SecurityCode`|Texto|4|Sim|Código de segurança impresso no verso do cartão|
|`CreditCard.Brand`|Texto|10|Sim |Bandeira do cartão|
|`Payment.ExtraDataCollection.Name`|Texto|50|Sim|enviar: SteloGuaranteed|
|`Payment.ExtraDataCollection.Value`|Booleano|---|Sim|enviar: True|
|`Payment.ExtraDataCollection.Name`|Texto|50|Sim|enviar: DeviceFingerPrint|
|`Payment.ExtraDataCollection.Value`|Texto|50|Sim|é necessária a inclusão de um bloco HTML na tela de checkout. <a href="https://m1sandbox.stelo.com.br/files/tranferblock.txt">Clique aqui</a> e baixe o arquivo com as instruções.|
|`Payment.ExtraDataCollection.Name`|Texto|50|Sim|enviar: ShippingBehavior|
|`Payment.ExtraDataCollection.Value`|Texto|20|Sim|enviar: DELIVERY|
|`Payment.ExtraDataCollection.Name`|Texto|50|Sim|enviar: Cart_1_Name|
|`Payment.ExtraDataCollection.Value`|Texto|50|Sim|nome do produto|
|`Payment.ExtraDataCollection.Name`|Texto|50|Sim|enviar: Cart_1_Quantity|
|`Payment.ExtraDataCollection.Value`|Number|10|Sim|quantidade de unidades do produto|
|`Payment.ExtraDataCollection.Name`|Texto|50|Sim|enviar: Cart_1_Price|
|`Payment.ExtraDataCollection.Value`|Numero|10|Sim|enviar o valor do item do carrinho|
|`Payment.ExtraDataCollection.Name`|Texto|50|Sim|enviar: Cart_2_Name|
|`Payment.ExtraDataCollection.Value`|Texto|50|Sim|nome do produto|
|`Payment.ExtraDataCollection.Name`|Texto|50|Sim|enviar: Cart_2_Quantity|
|`Payment.ExtraDataCollection.Value`|Number|10|Sim|quantidade de unidades do produto|
|`Payment.ExtraDataCollection.Name`|Texto|50|Sim|enviar: Cart_2_Price|
|`Payment.ExtraDataCollection.Value`|Numero|10|Sim|enviar o valor do item do carrinho|
...
```json
{
    ...
    "Payment": {
        ...
        "ProofOfSale": "506405",
        "AcquirerTransactionId": "1412171635",
        "AuthorizationCode": "424533",
        "PaymentId": "c49780e1-45f0-46fa-b9f7-4b96794ad405",
        "Type": "CreditCard",
        "Amount": 100,
        "ReceivedDate": "2017-12-14 16:35:03",
        "Currency": "BRL",
        "Country": "BRA",
        "Provider": "Stelo",
        "ExtraDataCollection": [{
        ...
        "ProviderReturnMessage": "Transação Aprovada",
        "Links": [{
            "Method": "GET",
            "Rel": "self",
            "Href": "https://apiqueryhomolog.braspag.com.br/v2/sales/c49780e1-45f0-46fa-b9f7-4b96794ad405"
        }]
    }
}
```
...
|`Payment.ExpirationDate`|Date |10 |Não|Dias para vencer o boleto. Caso não esteja previamente cadastrado no meio de pagamento, o envio deste campo é obrigatório. Se este campo for enviado na requisição, sobrepõe o valor configurado no meio de pagamento. Para solicitar o cadastramento do prazo de vencimento no meio de pagamento, é necessária a abertura de um chamado na [ferramenta de suporte da Braspag] (https://suporte.braspag.com.br/hc/pt-br/restricted?return_to=https%3A%2F%2Fsuporte.braspag.com.br%2Fhc%2Fpt-br).|
