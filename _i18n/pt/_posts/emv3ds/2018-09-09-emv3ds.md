...
| Payment.ExternalAuthentication.Cavv | É a assinatura que é retornado nos cenários de sucesso na autenticação | Alfanumérico [28 posições] | Sim, quando a autenticação foi um sucesso |
