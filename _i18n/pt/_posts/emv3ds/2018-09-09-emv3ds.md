...
- Ter afiliação com uma das adquirentes suportadas (Cielo, Rede ou Getnet);
...
As adquirentes que operam a autenticação 3DS 2.0 com a Braspag são Cielo, Rede e Getnet.
