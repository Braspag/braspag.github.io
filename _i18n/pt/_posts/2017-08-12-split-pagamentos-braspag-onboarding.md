...
| `MerchantCategoryCode`                                          | String  | 4       | Sim         | (MCC) número registrado na ISO 18245 para serviços financeiros de varejo, utilizado para classificar o negócio pelo tipo fornecido de bens ou serviços. [Lista de Merchant Category Codes](/manual/split/mcc.csv){:target="_blank"} |
