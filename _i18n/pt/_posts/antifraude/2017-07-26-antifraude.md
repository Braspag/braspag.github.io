...
|`ProviderAnalysisResult.ProviderStatus`|Status da transação na ReDShield <br/> [Tabela 17 - ProviderStatus]({{ site.baseurl_root }}manual/antifraude#tabela-17-providerstatus)|enum|
