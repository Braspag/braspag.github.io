...
|`MerchantDefinedData[n].Key`|Chave do valor do campo definido junto ao provedor de antifraude <br/> [Tabela 37 - MerchantDefinedData]({{ site.baseurl_root }}/manual/antifraude#tabela-37-merchantdefineddata-(cybersource))|int|não|-|
|`MerchantDefinedData[n].Value`|Valor do campo definido junto ao provedor de antifraude <br/> [Tabela 37 - MerchantDefinedData]({{ site.baseurl_root }}/manual/antifraude#tabela-37-merchantdefineddata-(cybersource))|var|não|-|
