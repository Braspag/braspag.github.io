...
|`MerchantDefinedData[n].Key`|Campo definido junto ao provedor de antifraude <br/> [Tabela 35 - MerchantDefinedData]({{ site.baseurl_root }/manual/antifraude#tabela-37-merchantdefineddata-(cybersource))|int|não|-|
|`MerchantDefinedData[n].Value`|Campo definido junto ao provedor de antifraude <br/> [Tabela 35 - MerchantDefinedData]({{ site.baseurl_root }/manual/antifraude#tabela-37-merchantdefineddata-(cybersource))|var|não|-|
