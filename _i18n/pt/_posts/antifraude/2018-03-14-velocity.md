...
|`CredilinkResult.Status`|Status do CPF ou CNPJ informado na Receita Federal <br/> [Tabela 3 - CredilinkResult.Status]({{ site.baseurl_root }}manual/antifraude#tabela-7-credilinkresult.status)|string|string|
