...
Uma transação a ser analisada e ter passado nas análises de regras, quarentena e lista negativa, os dados do comprador serão enviados para a Emailage. Na resposta da Emailage o score for de alto risco, o retorno terá que a transação foi rejeitada pela análise na Emailage.
...
Uma transação a ser analisada e ter passado nas análises de regras, quarentena, lista negativa e Emailage, este se estiver habilitado, os dados do comprador serão enviados para a Credilink. Após a análise na Credilink, não for encontrado nenhuma ocorrência, no retorno terá que a transação foi rejeitada pela na Credilink.
